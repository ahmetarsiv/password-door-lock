# Pasword Door Lock Contribution Guide

**BUGS:**

To encourage active collaboration, Pasword door lock project encourages pull requests, not just bug reports. "Bug reports" may also be sent in the form of a pull request containing a negative test.
...
Major new features should always be sent to the master branch, which contains the upcoming Pasword door lock release.
